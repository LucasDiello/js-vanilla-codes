...
export const createCartProductElement = ({ id, title, price, pictures }) => {
  ...
  li.addEventListener('click', (event) => {
    ...
    const subPrice = parseFloat(totalPrice.innerHTML)
     - parseFloat(getPrice.innerHTML);
    totalPrice.innerHTML = subPrice.toFixed(2);
    localStorage.setItem('totalPrice', subPrice.toFixed(2));
  });
